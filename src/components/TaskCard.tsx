...
function TaskCard({ task, deleteTask, updateTask }: Props) {
    ...
    flex text-left rounded-xl border-2 border-white cursor-grab relative"/>
    }
    ...
    if (editMode) {
        return (
            <div
                ...
                hover:ring-2 hover:ring-inset hover:ring-white cursor-grab relative">
                <textarea
                    className="h-[90%]
    ...
    return (
        ...
        hover:ring-2 hover:ring-inset hover:ring-white cursor-grab relative task"
            onMouseEnter={() => {
                setMouseIsOver(true)
            }}
            onMouseLeave={() => {
